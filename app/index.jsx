...
export default function Home(){
    ...
    const loadTasks = async () => {
        ...
        if(saved){
            ...
            // Garente que todas as tasks tenham o campo pomodoros com números mínimos 1
                ...
                <View style={s.container}>
                    ...
                    <View>
                        ...
                        <TouchableOpacity onPress={() => setFilter('todo')}>
                            <Text style={filter === 'all' ? s.active : s.filter}>Pendentes</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => setFilter('done')}>
                            <Text style={filter === 'all' ? s.active : s.filter}>Concluídas</Text>
                        </TouchableOpacity>
